...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    TT(3),          PETKAU_MACRO_NotEqual,     LALT(KC_LSHIFT),RALT(KC_LCTRL), KC_BSPACE,      MT(MOD_LCTL, KC_ESCAPE),                                                                                                MT(MOD_RCTL, KC_ESCAPE),KC_DELETE,      KC_TRANSPARENT, PETKAU_MACRO_EqualsArrow,     KC_BSLASH,      TT(3),          
