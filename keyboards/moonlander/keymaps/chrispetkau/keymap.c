...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [PETKAU_LAYER_COLEMAK] = LAYOUT_moonlander(
        ...
        TT(3), ST_MACRO_EQUALS_ARROW, ST_MACRO_TEMPLATE, LALT(KC_LSHIFT), KC_BSPACE, MT(MOD_LCTL, KC_ESCAPE), MT(MOD_RCTL, KC_ESCAPE), KC_DELETE, ST_MACRO_DASH_ARROW, ST_MACRO_TYPENAME, KC_BSLASH, TT(3),
