...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        KC_LPRN, KC_Q, KC_W, TD(DANCE_0), TD(DANCE_1), TD(DANCE_2), ST_MACRO_BREAK, TD(DANCE_10), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_RPRN,
        ...
        TT(4), ST_MACRO_NOT_EQUAL, LALT(KC_LSHIFT), LALT(KC_LCTRL), KC_BSPACE, MT(MOD_LCTL, KC_ESCAPE), MT(MOD_RCTL, KC_ESCAPE), KC_DELETE, ST_MACRO_EQUALS_ARROW, ST_MACRO_DASH_ARROW, KC_BSLASH, TT(4),
    ...
    [1] = LAYOUT_moonlander(
        ...
        KC_TAB, KC_TRANSPARENT, KC_TRANSPARENT, KC_E, KC_R, KC_T, KC_TRANSPARENT, TD(DANCE_13), KC_Y, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MINUS,
    ...
    [5] = LAYOUT_moonlander(
        ...
        ST_MACRO_FALSE, LSFT(KC_Z), LSFT(KC_X), LSFT(KC_C), LSFT(KC_V), LSFT(KC_B), LSFT(KC_N), LSFT(KC_M), KC_LABK, KC_RABK, KC_QUES, ST_MACRO_TRUE,
    ...
    [6] = LAYOUT_moonlander(
        ...
        ST_MACRO_FALSE, RSFT(KC_Z), RSFT(KC_X), RSFT(KC_C), RSFT(KC_V), RSFT(KC_B), RSFT(KC_N), RSFT(KC_M), KC_LABK, KC_RABK, KC_QUES, ST_MACRO_TRUE,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_PIPE, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_NULLPTR, KC_TRANSPARENT),
    [7] = LAYOUT_moonlander(
        KC_TILD, KC_1, KC_2, KC_3, KC_4, KC_5, ST_MACRO_BOOL, KC_TRANSPARENT, KC_6, KC_7, KC_8, KC_9, KC_0, KC_QUOTE,
