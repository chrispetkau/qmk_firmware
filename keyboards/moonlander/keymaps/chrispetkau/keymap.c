...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    LT(6,KC_Q),     KC_W,           LT(6,KC_F),     LT(2,KC_P),     KC_B,           KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_J,           KC_L,           LT(2,KC_U),     KC_Y,           KC_SCOLON,      
  ...
  [6] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_NO,          KC_NO,          TO(2),          DT_UP,     KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, RESET,          LGUI(KC_L),     TO(6),          KC_NO,          TO(4),          
