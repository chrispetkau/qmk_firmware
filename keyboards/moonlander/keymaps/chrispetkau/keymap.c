...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_EQUAL,       TD(DANCE_7),    LT(3,KC_R),     KC_S,           LT(4,KC_T),     TD(DANCE_8),    KC_ENTER,                                                                       CAPS_WORD,      KC_M,           LT(4,KC_N),     KC_E,           KC_I,           KC_O,           KC_UNDS,        
    MT(MOD_LSFT, KC_LBRACKET),TD(DANCE_9),    TD(DANCE_10),   TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),                                   KC_K,           KC_H,           KC_COMMA,       KC_DOT,         TD(DANCE_22),   KC_RBRACKET,    
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_NO,          LCTL(KC_A),     KC_TRANSPARENT, KC_LCTRL,       KC_LSHIFT,      KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_WWW_REFRESH, KC_PGUP,        KC_HOME,        KC_UP,          KC_END,         KC_NO,          KC_NO,          
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, PETKAU_MACRO_NullPtr,    LSFT(KC_TAB),                   LSFT(KC_TAB),   PETKAU_MACRO_Override,    PETKAU_MACRO_Return
  ),
};
