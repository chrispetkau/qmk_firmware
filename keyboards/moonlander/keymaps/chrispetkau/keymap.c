...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_moonlander(
    ...
    PETKAU_MACRO_ReinterpretCast,     PETKAU_MACRO_Struct,    PETKAU_MACRO_Class,    PETKAU_MACRO_Namespace,    PETKAU_MACRO_NullPtr,    KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, PETKAU_MACRO_Include,    PETKAU_MACRO_Define,    PETKAU_MACRO_IfDef,    PETKAU_MACRO_Else,    PETKAU_MACRO_EndIf,    
